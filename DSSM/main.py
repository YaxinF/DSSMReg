...
train = pd.read_csv(r"E:\DSSMReg\PreBNK\data\train.csv")
test = pd.read_csv(r"E:\DSSMReg\PreBNK\data\test.csv")
TF = pd.read_csv(R"E:\DSSMReg\PreBNK\emb\TF_OUT_input.csv", sep=',')
TG = pd.read_csv(R"E:\DSSMReg\PreBNK\emb\TG_OUT_input.csv", sep=',')
...
if __name__ == '__main__':
    ...
    plt.savefig(R"E:\DSSMReg\PreBNK\similarity\auroc.pdf")
    ...
    row_names = TF.iloc[:, 0]
    df.index = row_names
    df.to_csv(R"E:\DSSMReg\PreBNK\similarity\TF_emb.csv", index=True,header=True)
    # TG tower
    ...
    #Save the TG vector file
    df2.to_csv(R"E:\DSSMReg\PreBNK\similarity\TG_emb.csv", index=True,header=True)
